...
<article class="border-bottom pb-4 text-decoration-none">
    ...
    <h6>By: <a href="#" class="text-decoration-none">{{$post->user->name}}</a> in Category <a href="/category/{{ $post->category->slug }}" class="text-decoration-none">{{$post->category->name}}</a></h6> 
    <p>{{$post->excerpt}}</p>
